(function () {
  ...
  const copyRows = {
    ...
    mobileViewLabel: ["Allona Denizcilik mobil görünümü", "Allona Dənizçilik mobil görünüşü", "Allona Теңіз ісі мобильді көрінісі", "Allona Dengizchilik mobil ko‘rinishi", "Allona Деңизчилик мобилдик көрүнүшү", "Allona Maritime mobile view", "Mobile Ansicht von Allona Seefahrt", "Мобильная версия Allona Морское дело", "عرض Allona للملاحة البحرية على الجوال"],
    ...
    safetyTitle: ["Güvenli başvuru uyarısı", "Təhlükəsiz müraciət xəbərdarlığı", "Қауіпсіз өтінім ескертуі", "Xavfsiz ariza ogohlantirishi", "Коопсуз арыз эскертүүсү", "Safe application warning", "Sicherheitshinweis zur Bewerbung", "Предупреждение о безопасном отклике", "تنبيه للتقديم الآمن"],
    safetyText: ["Sadece doğrulanmış mavi rozetli firmalara başvurunuz. Komisyon veya ücret talep edenlere itibar etmeyiniz ve hiçbir koşulda ödeme yapmayınız.", "Yalnız təsdiqlənmiş mavi nişanlı şirkətlərə müraciət edin. Komissiya və ya ödəniş tələb edənlərə etibar etməyin və heç bir halda ödəniş etməyin.", "Тек расталған көк белгісі бар компанияларға өтінім беріңіз. Комиссия немесе төлем сұрағандарға сенбеңіз және еш жағдайда ақша төлемеңіз.", "Faqat tasdiqlangan ko‘k nishonli kompaniyalarga ariza bering. Komissiya yoki to‘lov so‘raganlarga ishonmang va hech qanday holatda pul to‘lamang.", "Текшерилген көк белгиси бар компанияларга гана арыз бериңиз. Комиссия же акы сурагандарга ишенбеңиз жана эч кандай шартта төлөбөңүз.", "Apply only to verified companies with a blue badge. Do not trust anyone asking for a commission or fee, and never make a payment.", "Bewerben Sie sich nur bei verifizierten Unternehmen mit blauem Haken. Vertrauen Sie niemandem, der Provisionen oder Gebühren verlangt, und leisten Sie unter keinen Umständen Zahlungen.", "Откликайтесь только на вакансии проверенных компаний с синей отметкой. Не доверяйте тем, кто требует комиссию или оплату, и ни при каких условиях не переводите деньги.", "قدّم فقط لدى الشركات الموثقة ذات الشارة الزرقاء. لا تثق بمن يطلب عمولة أو رسوماً، ولا تدفع أي مبلغ تحت أي ظرف."],
    ...
    jobsRailLabel: ["Yatay kaydırılabilir denizcilik iş ilanları", "Üfüqi sürüşdürülən dənizçilik iş elanları", "Көлденең айналдырылатын теңіз жұмыстары", "Gorizontal aylantiriladigan dengizchilik ish eʼlonlari", "Туурасынан жылдырылуучу деңиз жумуштары", "Horizontally scrollable maritime jobs", "Horizontal scrollbare maritime Stellen", "Морские вакансии с горизонтальной прокруткой", "وظائف بحرية قابلة للتمرير أفقياً"],
    ...
    marketRailLabel: ["Yatay kaydırılabilir denizcilik pazarı", "Üfüqi sürüşdürülən dənizçilik bazarı", "Көлденең айналдырылатын теңіз нарығы", "Gorizontal aylantiriladigan dengizchilik bozori", "Туурасынан жылдырылуучу деңизчилик базары", "Horizontally scrollable maritime market", "Horizontal scrollbarer maritimer Markt", "Морской рынок с горизонтальной прокруткой", "سوق بحري قابل للتمرير أفقياً"],
  ...
  function setupSearch() {
    ...
    form.addEventListener("submit", function (event) {
      ...
      const search = query ? `${copy.searchPrefix} ${query}` : copy.searchDefault;
