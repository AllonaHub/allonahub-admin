(function () {
  ...
  const copyRows = {
    ...
    prepareTitle: ["Belgelerinden iş hesabını hazırla", "Sənədlərindən iş hesabını hazırla", "Құжаттарыңыздан жұмыс аккаунтын дайындаңыз", "Hujjatlaringizdan ish hisobini tayyorlang", "Документтериңизден жумуш аккаунтун даярдаңыз", "Prepare your work account from your documents", "Arbeitskonto aus Dokumenten vorbereiten", "Подготовьте рабочий аккаунт по документам", "جهّز حساب العمل من مستنداتك"],
    prepareLead: ["Sistem onaylı belgelerini birlikte okur; GP CV taslağını, yeterlilik özetini, süre uyarılarını ve doğrulanmış ilan eşleşmelerini hazırlar.", "Sistem təsdiqlənmiş sənədləri birlikdə oxuyur; GP CV layihəsini, səriştə xülasəsini, müddət xəbərdarlıqlarını və təsdiqlənmiş elan uyğunluqlarını hazırlayır.", "Жүйе расталған құжаттарды бірге оқып, GP CV жобасын, біліктілік қорытындысын, мерзім ескертулерін және тексерілген вакансия сәйкестіктерін дайындайды.", "Tizim tasdiqlangan hujjatlarni birga o‘qib, GP CV loyihasi, malaka xulosasi, muddat ogohlantirishlari va tasdiqlangan eʼlon mosliklarini tayyorlaydi.", "Система ырасталган документтерди чогуу окуп, GP CV долбоорун, квалификация жыйынтыгын, мөөнөт эскертүүлөрүн жана текшерилген жарыя дал келүүлөрүн даярдайт.", "The system reads your confirmed documents together and prepares a GP CV draft, qualification summary, expiry alerts, and verified job matches.", "Das System liest bestätigte Dokumente gemeinsam und erstellt einen GP-CV-Entwurf, eine Qualifikationsübersicht, Ablaufwarnungen und verifizierte Jobabgleiche.", "Система совместно анализирует подтвержденные документы и готовит черновик GP CV, сводку квалификаций, предупреждения о сроках и совпадения с проверенными вакансиями.", "يقرأ النظام مستنداتك المؤكدة معًا ويجهز مسودة GP CV وملخص المؤهلات وتنبيهات الصلاحية ومطابقات الوظائف الموثقة."],
    prepareButton: ["Akıllı Hesabımı Hazırla", "Ağıllı hesabımı hazırla", "Ақылды аккаунтымды дайындау", "Aqlli hisobimni tayyorlash", "Акылдуу аккаунтумду даярдоо", "Prepare My Smart Account", "Mein Smart-Konto vorbereiten", "Подготовить умный аккаунт", "جهّز حسابي الذكي"],
    refreshButton: ["Yeniden Tara ve Güncelle", "Yenidən yoxla və yenilə", "Қайта тексеріп жаңарту", "Qayta tekshirish va yangilash", "Кайра текшерип жаңыртуу", "Scan Again and Update", "Neu prüfen und aktualisieren", "Повторно проверить и обновить", "أعد الفحص والتحديث"],
    ...
    documents: ["Onaylı belge", "Təsdiqli sənəd", "Расталған құжат", "Tasdiqlangan hujjat", "Ырасталган документ", "Confirmed documents", "Bestätigte Dokumente", "Подтвержденные документы", "المستندات المؤكدة"],
    ...
    prepareDone: ["Akıllı hesap hazırlandı. Özeti kontrol edip onaylayın.", "Ağıllı hesab hazırlandı. Xülasəni yoxlayıb təsdiqləyin.", "Ақылды аккаунт дайын. Қорытындыны тексеріп растаңыз.", "Aqlli hisob tayyor. Xulosani tekshirib tasdiqlang.", "Акылдуу аккаунт даяр. Жыйынтыкты текшерип ырастагыла.", "Smart account prepared. Review and confirm the summary.", "Smart-Konto vorbereitet. Übersicht prüfen und bestätigen.", "Умный аккаунт готов. Проверьте и подтвердите сводку.", "تم إعداد الحساب الذكي. راجع الملخص وأكده."],
    ...
    documentRequired: ["Akıllı hesabı hazırlamak için önce en az bir belge yükleyip okunan bilgileri onaylayın.", "Ağıllı hesab üçün əvvəlcə ən az bir sənəd yükləyib oxunan məlumatı təsdiqləyin.", "Ақылды аккаунт үшін кемінде бір құжат жүктеп, алынған деректерді растаңыз.", "Aqlli hisob uchun avval kamida bitta hujjat yuklab, o‘qilgan maʼlumotni tasdiqlang.", "Акылдуу аккаунт үчүн кеминде бир документ жүктөп, окулган маалыматты ырастагыла.", "Upload at least one document and confirm the extracted details before preparing the smart account.", "Laden Sie mindestens ein Dokument hoch und bestätigen Sie die Daten, bevor Sie das Smart-Konto vorbereiten.", "Сначала загрузите хотя бы один документ и подтвердите извлеченные данные.", "ارفع مستندًا واحدًا على الأقل وأكد البيانات المستخرجة قبل إعداد الحساب الذكي."],
    uploadDocuments: ["Belge Ekle", "Sənəd əlavə et", "Құжат қосу", "Hujjat qo‘shish", "Документ кошуу", "Add Document", "Dokument hinzufügen", "Добавить документ", "إضافة مستند"],
    ...
    viewCv: ["GP CV'yi Gör", "GP CV-ni göstər", "GP CV-ді көру", "GP CV-ni ko‘rish", "GP CV-ни көрүү", "View GP CV", "GP CV ansehen", "Посмотреть GP CV", "عرض GP CV"],
    cvActionLead: ["Belgelerinizden oluşan düzenli CV taslağını kontrol edin.", "Sənədlərinizdən yaradılan səliqəli CV layihəsini yoxlayın.", "Құжаттарыңыздан жасалған CV жобасын тексеріңіз.", "Hujjatlaringizdan yaratilgan CV loyihasini tekshiring.", "Документтериңизден түзүлгөн CV долбоорун текшериңиз.", "Review the structured CV draft created from your documents.", "Prüfen Sie den aus Ihren Dokumenten erstellten CV-Entwurf.", "Проверьте структурированный черновик CV из ваших документов.", "راجع مسودة السيرة المنظمة المنشأة من مستنداتك."],
    completeDocuments: ["Eksik Belgeleri Tamamla", "Çatışmayan sənədləri tamamla", "Жетіспейтін құжаттарды толықтыру", "Yetishmayotgan hujjatlarni to‘ldirish", "Жетишпеген документтерди толуктоо", "Complete Missing Documents", "Fehlende Dokumente ergänzen", "Дополнить недостающие документы", "استكمال المستندات الناقصة"],
    documentsActionLead: ["Yeni kontrat, deniz hizmeti, sertifika veya referans belgenizi ekleyin; onaydan sonra GP CV ve eşleşmeleriniz güncellensin.", "Yeni müqavilə, dəniz xidməti, sertifikat və ya istinad sənədinizi əlavə edin; təsdiqdən sonra GP CV və uyğunluqlar yenilənsin.", "Жаңа келісімшарт, теңіз қызметі, сертификат немесе ұсыным құжатын қосыңыз; растаудан кейін GP CV және сәйкестіктер жаңартылады.", "Yangi kontrakt, dengiz xizmati, sertifikat yoki tavsiya hujjatini qo‘shing; tasdiqdan keyin GP CV va mosliklar yangilanadi.", "Жаңы контракт, деңиз кызматы, сертификат же сунуш документин кошуңуз; ырастоодон кийин GP CV жана дал келүүлөр жаңыртылат.", "Add a new contract, sea-service, certificate, or reference document; your GP CV and matches refresh after approval.", "Fügen Sie einen neuen Vertrag, Dienstzeit-, Zertifikats- oder Referenznachweis hinzu; GP CV und Abgleiche werden nach der Bestätigung aktualisiert.", "Добавьте новый контракт, документ о стаже, сертификат или рекомендацию; после подтверждения GP CV и совпадения обновятся.", "أضف عقدًا جديدًا أو مستند خدمة بحرية أو شهادة أو مرجعًا؛ وسيتم تحديث GP CV والمطابقات بعد التأكيد."],
    ...
    cvTitle: ["Global Pasaport CV", "Global Pasport CV", "Global Passport CV", "Global Passport CV", "Global Passport CV", "Global Passport CV", "Global-Passport-CV", "Global Passport CV", "السيرة الذاتية لجواز السفر العالمي"],
    ...
    sourceNote: ["Bu CV yalnız sizin kontrol edip onayladığınız belge bilgilerinden oluşturulmuştur.", "Bu CV yalnız yoxlayıb təsdiqlədiyiniz sənəd məlumatlarından yaradılıb.", "Бұл CV тек сіз тексеріп растаған құжат деректерінен жасалды.", "Bu CV faqat siz tekshirib tasdiqlagan hujjat maʼlumotlaridan yaratildi.", "Бул CV сиз текшерип ырастаган документ маалыматтарынан гана түзүлдү.", "This CV was created only from document information you reviewed and confirmed.", "Dieser CV wurde nur aus von Ihnen geprüften und bestätigten Dokumentdaten erstellt.", "Этот CV создан только из проверенных и подтвержденных вами данных документов.", "أُنشئت هذه السيرة فقط من بيانات المستندات التي راجعتها وأكدتها."],
    ...
    cvCredentialLead: ["Kodlar, numaralar ve tarihler onayladığınız belgelerden aktarılmıştır.", "Kodlar, nömrələr və tarixlər təsdiqlədiyiniz sənədlərdən götürülüb.", "Кодтар, нөмірлер және күндер сіз растаған құжаттардан алынды.", "Kodlar, raqamlar va sanalar siz tasdiqlagan hujjatlardan olindi.", "Коддор, номерлер жана даталар сиз ырастаган документтерден алынды.", "Codes, numbers, and dates were transferred from documents you confirmed.", "Codes, Nummern und Daten wurden aus Ihren bestätigten Dokumenten übernommen.", "Коды, номера и даты перенесены из подтвержденных вами документов.", "نُقلت الرموز والأرقام والتواريخ من المستندات التي أكّدتها."],
    cvAutoRead: ["Belgeden otomatik", "Sənəddən avtomatik", "Құжаттан автоматты", "Hujjatdan avtomatik", "Документтен автоматтык", "Automatic from document", "Automatisch aus Dokument", "Автоматически из документа", "تلقائي من المستند"],
  ...
  Object.assign(copyRows, {
    ...
    cvSeaServicePending: ["Gemi hizmeti veya eski CV kayıtları yüklendiğinde gemi adı, şirket, bayrak, görev, tarihler, tonaj ve makine bilgileri bu bölüme otomatik eklenir.", "Gəmi xidməti və ya əvvəlki CV qeydləri yükləndikdə gəmi adı, şirkət, bayraq, vəzifə, tarixlər, tonaj və mühərrik məlumatları bu bölməyə avtomatik əlavə olunur.", "Кеме қызметі немесе бұрынғы CV деректері жүктелгенде кеме атауы, компания, ту, қызмет, күндер, тоннаж және қозғалтқыш мәліметтері осы бөлімге автоматты қосылады.", "Kema xizmati yoki eski CV qaydlari yuklanganda kema nomi, kompaniya, bayroq, lavozim, sanalar, tonnaj va dvigatel maʼlumotlari bu bo‘limga avtomatik qo‘shiladi.", "Кеме кызматы же мурдагы CV жазуулары жүктөлгөндө кеменин аты, компания, желек, кызмат, даталар, тоннаж жана кыймылдаткыч маалыматтары бул бөлүмгө автоматтык кошулат.", "When sea-service records or a previous CV are uploaded, vessel, company, flag, rank, dates, tonnage, and engine details are added here automatically.", "Nach dem Hochladen von Seefahrtsnachweisen oder eines früheren CV werden Schiff, Unternehmen, Flagge, Funktion, Zeiten, Tonnage und Maschinendaten automatisch ergänzt.", "После загрузки записей морского стажа или прежнего CV сюда автоматически добавляются судно, компания, флаг, должность, даты, тоннаж и двигатель.", "عند رفع سجلات الخدمة البحرية أو سيرة سابقة تُضاف هنا تلقائيًا تفاصيل السفينة والشركة والعلم والوظيفة والتواريخ والحمولة والمحرك."],
  ...
  function cvPreviewMarkup(run) {
    ...
    const avatar = safeAvatar(state.payload && state.payload.cv_identity && state.payload.cv_identity.avatar_url);
        ...
        <div class="maritime-cv-layout maritime-cv-layout--v4">
          ...
          <div class="maritime-cv-body">
            <header class="maritime-cv-profile-head">
              <div class="maritime-cv-avatar">${avatar ? `<img src="${escapeHtml(avatar)}" alt="${escapeHtml(holderName)}">` : `<span>${escapeHtml(initials(holderName))}</span>`}</div>
  ...
  function smartActionsMarkup(run, matches, drafts) {
    ...
    const needsDocuments = (readiness.missing_items || []).length > 0 || (readiness.expiry_alerts || []).length > 0;
    ...
    return `<section class="maritime-smart-actions">
      ...
      <div class="maritime-smart-action-rail">
        ...
        <article data-attention="${needsDocuments}"><i class="fa-solid fa-folder-open" aria-hidden="true"></i><div><h3>${escapeHtml(text(needsDocuments ? "completeDocuments" : "uploadDocuments"))}</h3><p>${escapeHtml(text("documentsActionLead"))}</p></div><a class="maritime-button${needsDocuments ? " maritime-button--danger" : ""}" href="maritime-documents.html?mode=update#maritimeDocumentUpload">${escapeHtml(text(needsDocuments ? "completeDocuments" : "uploadDocuments"))}</a></article>
  ...
  function readinessMarkup(run) {
    ...
    <section class="maritime-smart-metrics">
      ...
      ${summaryMetric("fa-file-shield", String(readiness.confirmed_document_count || 0), text("documents"))}
    </section>
  ...
  async function prepare() {
    ...
    try {
      ...
      if (error.status === 409 && !state.payload?.run) {
        const target = root();
        if (target) target.insertAdjacentHTML("beforeend", `<a class="maritime-button maritime-button--danger" href="maritime-documents.html"><i class="fa-solid fa-cloud-arrow-up" aria-hidden="true"></i>${escapeHtml(text("uploadDocuments"))}</a>`);
      }
    } finally {
      setBusy(false);
    }
