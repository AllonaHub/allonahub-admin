...
function trustedVesselPhotoSourceUrl(value){
  ...
  en: {
    ...
    pdfPaymentUnavailable:"Paid PDF downloads are not available yet. Saving, viewing and creating Global CV remain free.",
    ...
    pdfNetworkFailed:"İndirme servisine ulaşılamadı. Kayıtlı CV'niz değişmedi. Bağlantınızı kontrol edip yeniden deneyin.",
    pdfPaymentUnavailable:"Ücretli PDF indirme için ödeme bağlantısı henüz etkin değil. CV kaydetme, görüntüleme ve Global CV oluşturma ücretsiz olarak kullanılabilir.",
    pdfDeviceFailed:"İndirme için cihaz doğrulaması tamamlanmalı. Maritime CV'yi açıp kaydetme doğrulamasını tamamlayın.",
    ...
    pdfNetworkFailed:"Endirmə xidmətinə qoşulmaq olmadı. Saxlanmış CV dəyişməyib. Bağlantını yoxlayıb yenidən cəhd edin.",
    pdfPaymentUnavailable:"Ödənişli PDF endirmə üçün ödəniş bağlantısı hələ aktiv deyil. CV saxlamaq, baxmaq və Global CV yaratmaq pulsuzdur.",
    pdfDeviceFailed:"Endirmə üçün cihaz təsdiqi lazımdır. Maritime CV-də saxlama təsdiqini tamamlayın.",
    ...
    pdfNetworkFailed:"Сервис скачивания недоступен. CV сохранено. Проверьте соединение и повторите попытку.",
    pdfPaymentUnavailable:"Оплата скачивания PDF ещё не подключена. Сохранение, просмотр и создание Global CV бесплатны.",
    pdfDeviceFailed:"Для скачивания подтвердите устройство при сохранении Maritime CV.",
