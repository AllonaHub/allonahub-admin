(function () {
  ...
  const maxBatchBytes = maxFileBytes;
  ...
  const copyRows = {
    ...
    uploadLead: ["Belgelerinizin görüntülerini tek bir PDF'de birleştirip yükleyin. Bu arşiv CV bilgilerinizi değiştirmez.", "Sənədlərinizin şəkillərini bir PDF-də birləşdirib yükləyin. Bu arxiv CV məlumatınızı dəyişmir.", "Құжат суреттерін бір PDF файлына біріктіріп жүктеңіз. Мұрағат CV деректерін өзгертпейді.", "Hujjat rasmlarini bitta PDFga birlashtirib yuklang. Arxiv CV maʼlumotini o‘zgartirmaydi.", "Документ сүрөттөрүн бир PDFке бириктирип жүктөңүз. Архив CV маалыматын өзгөртпөйт.", "Combine your document images into one PDF and upload it. This archive does not change your CV data.", "Fassen Sie Ihre Dokumentbilder in einer PDF zusammen und laden Sie sie hoch. Das Archiv ändert Ihre CV-Daten nicht.", "Объедините изображения документов в один PDF и загрузите его. Архив не меняет данные CV.", "اجمع صور مستنداتك في ملف PDF واحد وارفعه. لا يغير الأرشيف بيانات سيرتك."],
    ...
    fileLimits: ["Tek PDF, en fazla 20 MB.", "Bir PDF, ən çox 20 MB.", "Бір PDF, ең көбі 20 МБ.", "Bitta PDF, ko‘pi bilan 20 MB.", "Бир PDF, эң көп 20 МБ.", "One PDF, maximum 20 MB.", "Eine PDF, maximal 20 MB.", "Один PDF, не более 20 МБ.", "ملف PDF واحد، بحد أقصى 20 ميغابايت."],
    ...
    tooLarge: ["PDF 20 MB sınırını aşıyor.", "PDF 20 MB həddini aşır.", "PDF 20 МБ шегінен асты.", "PDF 20 MB chegaradan oshdi.", "PDF 20 МБ чегинен ашты.", "The PDF exceeds 20 MB.", "Die PDF überschreitet 20 MB.", "PDF превышает 20 МБ.", "يتجاوز ملف PDF حد 20 ميغابايت."],
    tooMany: ["Lütfen tek PDF seçin.", "Yalnız bir PDF seçin.", "Тек бір PDF таңдаңыз.", "Faqat bitta PDF tanlang.", "Бир гана PDF тандаңыз.", "Please select one PDF.", "Bitte eine PDF auswählen.", "Выберите один PDF.", "يرجى اختيار ملف PDF واحد."],
    totalTooLarge: ["PDF 20 MB sınırını aşıyor.", "PDF 20 MB həddini aşır.", "PDF 20 МБ шегінен асты.", "PDF 20 MB chegaradan oshdi.", "PDF 20 МБ чегинен ашты.", "The PDF exceeds 20 MB.", "Die PDF überschreitet 20 MB.", "PDF превышает 20 МБ.", "يتجاوز ملف PDF حد 20 ميغابايت."],
