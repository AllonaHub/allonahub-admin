const ALLONAHUB_CACHE = "allonahub-pwa-20260712-theme-text1";
const APP_SHELL = [
  "./",
  "./index.html",
  "./manifest.json?v=20260622-icon1",
  "./manifest.webmanifest?v=20260622-icon1",
  "./css/allonahub-home.css?v=20260712-homefix1",
  "./css/platform.css?v=20260712-theme-text1",
  ...
  "./js/platform.js?v=20260712-theme-text1",
  "./js/sw-refresh.heading2.js?v=20260712-theme-text1",
  "./js/privacy-consent.js?v=20260712-theme-text1",
  "./js/allonahub-home.js?v=20260712-homefix1",
  "./js/pwa-install.js?v=20260712-theme-text1",
