const ALLONAHUB_CACHE = "allonahub-pwa-20260712-homefix1";
const APP_SHELL = [
  "./",
  "./index.html",
  ...
  "./css/platform.css?v=20260712-homefix1",
  ...
  "./js/platform.js?v=20260712-homefix1",
  "./js/sw-refresh.heading2.js?v=20260712-homefix1",
  "./js/privacy-consent.js?v=20260712-homefix1",
  "./js/allonahub-home.js?v=20260712-homefix1",
  "./js/pwa-install.js?v=20260712-homefix1",
