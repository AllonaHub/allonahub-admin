const ALLONAHUB_CACHE = "allonahub-pwa-20260622-corp1";
const APP_SHELL = [
  "./",
  "./index.html",
  "./manifest.json?v=20260622-icon1",
  "./manifest.webmanifest?v=20260622-icon1",
  "./css/allonahub-home.css?v=20260622-corp1",
  "./css/platform.css?v=20260622-corp1",
  ...
  "./js/pwa-install.js?v=20260622-corp1",
