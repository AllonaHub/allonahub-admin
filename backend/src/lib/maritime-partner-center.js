...
export const MARIPARTNER_JOB_RANKS = Object.freeze({
  ...
  fitter: "Fitter",
  welder: "Kaynakçı",
  eto: "Elektro-Teknik Zabiti (ETO)",
  electro_technical_rating: "Elektro-Teknik Tayfa (ETR)",
  pumpman: "Pompaman / Pumpman",
  chief_cook: "Baş Aşçı",
  cook: "Aşçı",
  steward: "Kamarot / Steward",
  electrician: "Elektro-Teknik Zabiti (eski kayıt)"
});
...
export const MARIPARTNER_CERTIFICATE_CATALOG = Object.freeze({
  ...
  FITTER: "Fitter Mesleki Yeterlilik Belgesi",
  WELDER: "Kaynakçı Mesleki Yeterlilik Belgesi",
  "FOOD-HYG": "Gıda Hijyeni ve Mutfak Güvenliği",
...
export const MARIPARTNER_RANK_CERTIFICATE_CODES = Object.freeze({
  ...
  deck_cadet: Object.freeze([]),
  bosun: Object.freeze(["II/5", "VI/2-1"]),
  able_seaman: Object.freeze(["II/5", "VI/2-1"]),
  ordinary_seaman: Object.freeze(["II/4"]),
  deck_boy: Object.freeze([]),
  ...
  fourth_engineer: Object.freeze(["III/1", "VI/2-1", "VI/3", "VI/4-1", "ERM"]),
  engine_cadet: Object.freeze([]),
  engine_bosun: Object.freeze(["III/5", "VI/2-1"]),
  able_engine_rating: Object.freeze(["III/5", "VI/2-1"]),
  motorman: Object.freeze(["III/4"]),
  oiler: Object.freeze(["III/4"]),
  wiper: Object.freeze([]),
  fitter: Object.freeze(["III/4"]),
  welder: Object.freeze([]),
  eto: Object.freeze(["III/6", "VI/2-1", "VI/3", "VI/4-1"]),
  electro_technical_rating: Object.freeze(["III/7"]),
  pumpman: Object.freeze(["II/4"]),
  chief_cook: Object.freeze(["SHIP-COOK"]),
