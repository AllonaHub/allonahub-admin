...
const rankAliases = new Map([
  ...
  ["deck cadet", "deck_cadet"], ["deck trainee", "deck_cadet"], ["guverte kadeti", "deck_cadet"], ["guverte stajyeri", "deck_cadet"],
  ...
  ["engine cadet", "engine_cadet"], ["engine trainee", "engine_cadet"], ["makine kadeti", "engine_cadet"], ["makine stajyeri", "engine_cadet"],
  ["electro technical officer", "eto"], ["electro-technical officer", "eto"], ["eto", "eto"],
  ["electrician", "electrician"], ["elektrikci", "electrician"], ["gemi elektrikcisi", "electrician"],
  ["electro technical rating", "electro_technical_rating"], ["electro-technical rating", "electro_technical_rating"], ["etr", "electro_technical_rating"], ["elektro teknik tayfa", "electro_technical_rating"],
  ["bosun", "bosun"], ["boatswain", "bosun"], ["lostromo", "bosun"], ["guverte lostromosu", "bosun"], ["reis", "bosun"],
  ...
  ["deck boy", "deck_boy"], ["micho", "deck_boy"], ["mico", "deck_boy"], ["miço", "deck_boy"], ["guverte tayfasi", "deck_boy"],
  ["engine bosun", "engine_bosun"], ["machine bosun", "engine_bosun"], ["makine lostromosu", "engine_bosun"],
  ["able engine rating", "able_engine_rating"], ["able seafarer engine", "able_engine_rating"], ["usta makine tayfasi", "able_engine_rating"], ["usta yagci", "able_engine_rating"], ["stcw iii 5", "able_engine_rating"],
  ["motorman", "motorman"], ["motorcu", "motorman"],
  ["oiler", "oiler"], ["yagci", "oiler"],
  ["wiper", "wiper"], ["silici", "wiper"], ["makine tayfasi", "wiper"],
  ["fitter", "fitter"], ["welder", "welder"], ["kaynakci", "welder"],
  ["pumpman", "pumpman"], ["pompaman", "pumpman"], ["pompaci", "pumpman"], ["postman", "pumpman"],
  ["chief cook", "chief_cook"], ["bas asci", "chief_cook"],
  ["cook", "cook"], ["asci", "cook"],
...
function seaServiceRecord(rowValue) {
  ...
  const normalized = {
    ...
    vessel_photo_url: text(row.vessel_photo_url) || null,
    vessel_photo_source_url: text(row.vessel_photo_source_url) || null,
    vessel_photo_credit: text(row.vessel_photo_credit) || null,
