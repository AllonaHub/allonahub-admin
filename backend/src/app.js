  ...
  const app = Fastify({
    logger: {
      ...
      redact: [
        ...
        "MARITIME_REFERENCE_RESEND_API_KEY",
        "RESEND_API_KEY",
        ...
        "COMPANY_LOOKUP_TR_API_TOKEN",
        "COMPANY_LOOKUP_GB_API_KEY",
        ...
        "config.maritimeReferenceNotifications.resendApiKey",
        ...
        "config.companyLookup.turkeyApiToken",
        "config.companyLookup.companiesHouseApiKey",
        "companyLookup.turkeyApiToken",
        "companyLookup.companiesHouseApiKey",
        "config.cronSecret",
