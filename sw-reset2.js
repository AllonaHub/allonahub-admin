const ALLONAHUB_CACHE = "allonahub-pwa-20260626-mobile-std32";
const APP_SHELL = [
  "./",
  "./index.html",
  "./manifest.json?v=20260622-icon1",
  "./manifest.webmanifest?v=20260622-icon1",
  "./css/allonahub-home.css?v=20260626-mobile-std32",
  "./css/platform.css?v=20260626-mobile-std32",
  "./css/home-module-labels.std30.css",
  "./css/home-module-labels-turquoise.std31.css",
  ...
  "./js/layout.v3.js?v=20260626-mobile-std32",
  "./js/platform.js?v=20260626-mobile-std32",
  "./js/allonahub-home.js?v=20260626-mobile-std32",
  "./js/pwa-install.js?v=20260626-mobile-std32",
