const ALLONAHUB_CACHE = "allonahub-pwa-20260626-mobile-std22";
const APP_SHELL = [
  "./",
  "./index.html",
  "./manifest.json?v=20260622-icon1",
  "./manifest.webmanifest?v=20260622-icon1",
  "./css/allonahub-home.css?v=20260626-mobile-std22",
  "./css/platform.css?v=20260626-mobile-std22",
  ...
  "./js/layout.v3.js?v=20260626-mobile-std22",
  "./js/platform.js?v=20260626-mobile-std22",
  "./js/allonahub-home.js?v=20260626-mobile-std22",
  "./js/pwa-install.js?v=20260626-mobile-std22",
