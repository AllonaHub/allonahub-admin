...
- Maritime CV PII taslağı sürümlü ve 2 saat süreli `sessionStorage` envelope'u kullanıyor; eski `localStorage` anahtarını bir kez taşıyıp siliyor, bozuk/süresi geçmiş/yanlış modüllü veriyi reddediyor ve bağımsız sekmeye yaymıyor.
